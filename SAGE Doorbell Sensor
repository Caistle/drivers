...
metadata {
	definition (name: "SAGE Doorbell Sensor", namespace: "trunzoc", author: "Craig Trunzo") {
    	//capability "Battery"
    ...
    preferences {
		section {
				input (
					type: "number",
					name: "timeBetweenPresses",
					title: "Seconds allowed between presses (increase this value to eliminate duplicate notifications)",
					required: false,
                    defaultValue: 10,
				...
				input (
					type: "text",
					name: "button1Name",
					title: "Doorbell name to be associated with the 'Front Door' contact...",
					required: false,
				...
				input (
					type: "text",
					name: "button2Name",
					title: "Doorbell name to be associated with the 'Rear Door' contact...",
					required: false,
                    defaultValue: "Rear Door",
                    displayDuringSetup: true
				)
        }
    } 
...
private Map getDoorbellPressResult(cluster) {
    ...
    switch(buttonNumber) {
        case 0: 
            ...
            {
                log.debug ("${button2Name} Doorbell Pressed!")       
        ...
        case 1: 
            ...
            {		
		       log.debug ("${button1Name} Doorbell Pressed!")
