 ...
 */
metadata {
	definition (name: 'Virtual Battery Sensor', namespace: 'simnet', author: 'Simon Burke', importURL: "https://raw.githubusercontent.com/Caistle/drivers/main/VirtualBatterySensor.groovy?token=AU7T2OAC4H4QVIURLVOZ3J3BXMIAM") {
        capability 'Battery'
