 ...
 */
metadata {
	definition (name: 'Virtual Battery Sensor', namespace: 'simnet', author: 'Simon Burke', importURL: "https://raw.githubusercontent.com/Caistle/drivers/main/VirtualBatterySensor.groovy?token=AU7T2OA2FEK6T3X2MMKZ74DBXIG3Y") {
        capability 'Battery'
